...
Current features include chat data display, filtered messages, user analysis, local moderator notes, selected-message tracking, timeout command preparation, shoutout command preparation, action logging, collapsible panels, language switching, and a draggable Twitch overlay button.

All features that require direct Twitch API access are currently marked as WIP. Once Twitch Developer Console/API access is available, planned features include Twitch OAuth login, real moderator-right verification, direct timeout/ban/delete/pin actions, AutoMod approval/denial, direct shoutouts, and editable stream information.
...
Das Tool stellt ein lokales Moderations-Dashboard bereit, das Moderatoren dabei helfen soll, Chataktivität, auffällige Nachrichten, User-Verhalten, Notizen und vorbereitete Moderationsaktionen übersichtlicher zu verwalten, ohne ständig zwischen Twitch-Chat, Commands und externen Tools wechseln zu müssen.
